(function(S) {
  ...
  var methods = {
    ...
    generateLinks: function(options) {
      this.links = {
        'twitter': '<a target="_blank" title="Twitt it!" href="http://twitter.com/home?status=' + sub$('title').html() + '+-+' + document.location + '"><img alt="twitter" src="' + options.iconsPath + '/twitter.png"></a>',
        ...
        'linkedin': '<a target="_blank" title="Share on LinkedIn" href="http://www.linkedin.com/shareArticle?mini=true&url=' + document.location + '&title=' + sub$('title').html() + '"><img alt="linkedin" src="' + options.iconsPath + '/linkedin.png"></a>',
